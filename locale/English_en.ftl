...
context_menu_save_pack = Save Pack
context_menu_save_pack_as = Save Pack As…
context_menu_close_pack = Close Pack
...
settings_theme_os = OS Preferred
...
settings_clean_ui = Clean UI
tt_settings_clean_ui_tip = Check this to hide non-essential parts of the UI.
settings_single_pack_mode = Single Pack Mode
tt_settings_single_pack_mode_tip = Check this to only keep one Pack open at a time. Opening a Pack will close any already-open Pack first.
settings_global_search_collapse_results = Collapse Global Search Results
tt_settings_global_search_collapse_results_tip = Check this to show Global Search results collapsed by default, instead of expanding every file's matches automatically.
settings_global_search_auto_select_open_packs = Auto-select Open Packs in Global Search
tt_settings_global_search_auto_select_open_packs_tip = Check this to automatically select newly opened Packs as a Global Search source. Uncheck to leave them unselected until you pick them manually.
...
tt_settings_theme_tip = Choose the UI theme. 'OS Preferred' follows your system's light/dark setting; 'Light'/'Dark' force that scheme regardless of the OS.
...
tt_settings_autosave_interval_tip = Time in minutes between automatic saves of open PackFiles. Set to 0 to disable.
