...
use rpfm_lib::files::{Container, db::DB, loc::Loc, pack::Pack, RFileDecoded};
...
pub trait Optimizable {
    ...
    fn optimize(&mut self, game_info: &GameInfo, game_path: &Path, dependencies: &mut Dependencies) -> bool;
}
