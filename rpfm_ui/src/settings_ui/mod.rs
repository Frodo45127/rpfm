...
impl SettingsUI {
    ...
    pub unsafe fn load(&self) -> Result<()> {
        ...
        *self.font_data.borrow_mut() = (settings.string("font_name"), settings.i32("font_size"));
        ...
        self.extra_packfile_optimize_not_renamed_packedfiles_checkbox.set_checked(settings.bool("optimize_not_renamed_packedfiles"));
    ...
    pub unsafe fn save(&self) -> Result<()> {
        ...
        let _ = settings.set_bool("optimize_not_renamed_packedfiles", self.extra_packfile_optimize_not_renamed_packedfiles_checkbox.is_checked());
