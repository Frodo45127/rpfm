...
impl PackedFileExternalView {
    ...
    pub unsafe fn new_view(
        ...
        let current_name_label = QLabel::from_q_string_q_widget(&qtr("external_current_path"), file_view.main_widget());
        let current_name_data_label = QLabel::from_q_string_q_widget(&QString::from_std_str(format!("{:?}", external_path.display())), file_view.main_widget());
        let stop_watching_button = QPushButton::from_q_string_q_widget(&qtr("stop_watching"), file_view.main_widget());
        let open_folder_button = QPushButton::from_q_string_q_widget(&qtr("open_folder"), file_view.main_widget());
        ...
        file_view.view_type = ViewType::External(packed_file_external_view);
        file_view.file_type = FileType::Unknown;
    }
