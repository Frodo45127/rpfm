...
/*!
Module with the slots for AnimTable Views.
!*/
...
use crate::packedfile_views::animtable::PackedFileAnimTableViewRaw;
use crate::UI_STATE;
...
/// This struct contains the slots of the view of an AnimTable PackedFile.
pub struct PackedFileAnimTableViewSlots {
...
/// Implementation for `PackedFileAnimTableViewSlots`.
impl PackedFileAnimTableViewSlots {

    /// This function creates the entire slot pack for AnimTables.
    pub unsafe fn new(packed_file_view: &PackedFileAnimTableViewRaw, mut app_ui: AppUI, mut pack_file_contents_ui: PackFileContentsUI, global_search_ui: GlobalSearchUI) -> Self {
