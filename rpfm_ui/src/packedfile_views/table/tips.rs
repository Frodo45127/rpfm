...
/*!
Module with all the code to setup the tips (in the `StatusBar`) for the actions in `PackedFileTableView`.
!*/

use crate::locale::qtr;
use super::PackedFileTableView;

/// This function sets the status bar tip for all the actions in the provided `PackedFileTableView`.
