...
pub fn set_shortcuts(ui: &PackFileContentsUI) {
    ...
    unsafe { ui.context_menu_add_file.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["add_file"]))); }
    unsafe { ui.context_menu_add_folder.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["add_folder"]))); }
    unsafe { ui.context_menu_add_from_packfile.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["add_from_packfile"]))); }
    unsafe { ui.context_menu_check_tables.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["check_tables"]))); }
    unsafe { ui.context_menu_new_folder.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["create_folder"]))); }
    unsafe { ui.context_menu_new_packed_file_db.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["create_db"]))); }
    unsafe { ui.context_menu_new_packed_file_loc.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["create_loc"]))); }
    unsafe { ui.context_menu_new_packed_file_text.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["create_text"]))); }
    unsafe { ui.context_menu_mass_import_tsv.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["mass_import_tsv"]))); }
    unsafe { ui.context_menu_mass_export_tsv.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["mass_export_tsv"]))); }
    unsafe { ui.context_menu_merge_tables.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["merge_tables"]))); }
    unsafe { ui.context_menu_delete.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["delete"]))); }
    unsafe { ui.context_menu_extract.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["extract"]))); }
    unsafe { ui.context_menu_rename.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["rename"]))); }
    unsafe { ui.context_menu_open_decoder.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["open_in_decoder"]))); }
    unsafe { ui.context_menu_open_dependency_manager.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["open_packfiles_list"]))); }
    unsafe { ui.context_menu_open_containing_folder.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["open_containing_folder"]))); }
    unsafe { ui.context_menu_open_with_external_program.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["open_with_external_program"]))); }
    unsafe { ui.context_menu_open_notes.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["open_notes"]))); }
    unsafe { ui.packfile_contents_tree_view_expand_all.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["expand_all"]))); }
    unsafe { ui.packfile_contents_tree_view_collapse_all.as_mut().unwrap().set_shortcut(&KeySequence::from_string(&QString::from_std_str(&shortcuts.packfile_contents_tree_view["collapse_all"]))); }
