...
impl PackFileContentsUI {
    ...
    pub unsafe fn new(app_ui: &Rc<AppUI>) -> Self {
        ...
        let context_menu_add_file = add_action_to_menu(&menu_add.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Add File", "context_menu_add_file");
        let context_menu_add_folder = add_action_to_menu(&menu_add.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Add Folder", "context_menu_add_folder");
        let context_menu_add_from_packfile = add_action_to_menu(&menu_add.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Add From Pack", "context_menu_add_from_packfile");
        let context_menu_new_folder = add_action_to_menu(&menu_create.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "New Folder", "context_menu_new_folder");
        let context_menu_new_packed_file_anim_pack = add_action_to_menu(&menu_create.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "New AnimPack", "context_menu_new_packed_file_anim_pack");
        let context_menu_new_packed_file_db = add_action_to_menu(&menu_create.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "New DB", "context_menu_new_packed_file_db");
        let context_menu_new_packed_file_loc = add_action_to_menu(&menu_create.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "New Loc", "context_menu_new_packed_file_loc");
        let context_menu_new_packed_file_text = add_action_to_menu(&menu_create.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "New Text", "context_menu_new_packed_file_text");
        let context_menu_new_queek_packed_file = add_action_to_menu(&menu_create.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "New Quick File", "context_menu_new_queek_packed_file");
        ...
        let context_menu_copy_path = add_action_to_menu(&packfile_contents_tree_view_context_menu.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Copy Path", "context_menu_copy_path");
        let context_menu_open_decoder = add_action_to_menu(&menu_open.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Open In Decoder", "context_menu_open_decoder");
        let context_menu_open_dependency_manager = add_action_to_menu(&menu_open.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Open Dependency Manager", "context_menu_open_dependency_manager");
        let context_menu_open_containing_folder = add_action_to_menu(&menu_open.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Open Containing Folder", "context_menu_open_containing_folder");
        let context_menu_open_packfile_settings = add_action_to_menu(&menu_open.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Open Pack Settings", "context_menu_open_packfile_settings");
        let context_menu_open_with_external_program = add_action_to_menu(&menu_open.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Open In External Program", "context_menu_open_with_external_program");
        let context_menu_open_notes = add_action_to_menu(&menu_open.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Open Pack Notes", "context_menu_open_notes");
        let context_menu_merge_tables = add_action_to_menu(&packfile_contents_tree_view_context_menu.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Merge Tables", "context_menu_merge_tables");
        let context_menu_update_table = add_action_to_menu(&packfile_contents_tree_view_context_menu.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Update Tables", "context_menu_update_table");
        let context_menu_generate_missing_loc_data = add_action_to_menu(&packfile_contents_tree_view_context_menu.static_upcast(), app_ui.shortcuts().as_ref(), "pack_tree_context_menu", "Generate Missing Loc Data", "context_menu_generate_missing_loc_data");
