            ...
            Command::DecodePackedFile(path, data_source) => {
                ...
                dbg!(file.file_type());
                                    ...
                                    match result {
                                        ...
                                        Ok(RFileDecoded::CEO(data)) => CentralCommand::send_back(&sender, Response::ESFRFileInfo(data, From::from(&*file))),
                                        ...
                                        Ok(RFileDecoded::Save(data)) => CentralCommand::send_back(&sender, Response::ESFRFileInfo(data, From::from(&*file))),
