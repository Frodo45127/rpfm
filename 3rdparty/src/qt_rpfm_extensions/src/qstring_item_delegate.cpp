...
extern "C" void new_qstring_item_delegate(QObject *parent, const int column, QTimer* timer, bool is_dark_theme_enabled, bool has_filter, bool right_side_mark, bool enable_diff_markers) {
    QStringItemDelegate* delegate = new QStringItemDelegate(parent, timer, is_dark_theme_enabled, has_filter, right_side_mark, enable_diff_markers);
...
QStringItemDelegate::QStringItemDelegate(QObject *parent, QTimer* timer, bool is_dark_theme_enabled, bool has_filter, bool right_side_mark, bool enable_diff_markers):
