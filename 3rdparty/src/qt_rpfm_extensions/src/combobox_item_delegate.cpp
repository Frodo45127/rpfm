...
extern "C" void new_combobox_item_delegate(QObject *parent, const int column, const QStringList* values, const QStringList* lookups, const bool is_editable, QTimer* timer, bool is_dark_theme_enabled, bool has_filter, bool right_side_mark, bool enable_diff_markers) {
    QComboBoxItemDelegate* delegate = new QComboBoxItemDelegate(parent, *values, *lookups, is_editable, timer, is_dark_theme_enabled, has_filter, right_side_mark, enable_diff_markers);
...
QComboBoxItemDelegate::QComboBoxItemDelegate(QObject *parent, const QStringList provided_values, const QStringList provided_lookups, bool is_editable, QTimer* timer, bool is_dark_theme_enabled, bool has_filter, bool right_side_mark, bool enable_diff_markers):
