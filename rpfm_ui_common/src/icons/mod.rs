...
impl Icons {
    pub unsafe fn new() -> Self {
        Self {
            ...
            font: atomic_from_cpp_box(Self::load_icon("esf", "application-x-font-type1")),
            group_formations: atomic_from_cpp_box(Self::load_icon("group_formations", "dialog-transform")),
