...
license=('MIT')
depends=('qt5-base' 'qt5-imageformats' 'ktexteditor' 'kiconthemes' 'breeze-icons' 'xz' 'p7zip')
provides=('rpfm')
_programname=('rpfm')

source_x86_64=("$url/releases/download/v${pkgver}/rpfm-v${pkgver}-x86_64-unknown-linux-gnu.tar.zst")
sha256sums_x86_64=('67009033994809aa1f51579036ba78f1bca89928065042086bc8110098192451')
