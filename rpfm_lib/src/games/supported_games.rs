        ...
        game_list.insert(KEY_WARHAMMER_3, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War WARHAMMER III".to_owned(),
        ...
        game_list.insert(KEY_TROY, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinEpic, InstallData {
                    ...
                    root_folder_name: "Total War Saga Troy".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
        ...
        game_list.insert(KEY_THREE_KINGDOMS, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War THREE KINGDOMS".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_WARHAMMER_2, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War WARHAMMER II".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_WARHAMMER, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War WARHAMMER".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_THRONES_OF_BRITANNIA, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War Saga Thrones of Britannia".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_ATTILA, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War Attila".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_ROME_2, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War Rome II".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_SHOGUN_2, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Total War SHOGUN 2".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_NAPOLEON, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Napoleon Total War".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
        ...
        game_list.insert(KEY_EMPIRE, GameInfo {
            ...
            install_data: {
                ...
                data.insert(InstallType::WinSteam, InstallData {
                    ...
                    root_folder_name: "Empire Total War".to_owned(),
                    data_path: "data".to_owned(),
                    language_path: "data".to_owned(),
                    local_mods_path: "data".to_owned(),
