...
/*
    ...
    fn write<W: WriteBytes>(&mut self, data: &mut W) -> Result<()> {
        ...
        self.files.par_iter_mut().try_for_each(|(path, file)| {
        ...
        self.files.sort_unstable_by_key(|a| a.get_path().join("\\").to_lowercase());
