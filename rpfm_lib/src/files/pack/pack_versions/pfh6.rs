...
impl Pack {
    ...
    pub(crate) fn read_pfh6<R: ReadBytes>(&mut self, data: &mut R) -> Result<u64> {
        ...
        // The rest of the header data is 284 bytes.
        let extra_header_size = 284;
    ...
    pub(crate) fn write_pfh6<W: WriteBytes>(&mut self, buffer: &mut W, sevenzip_exe_path: Option<&Path>, test_mode: bool) -> Result<()> {
