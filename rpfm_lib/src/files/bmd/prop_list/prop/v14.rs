...
impl Prop {
    ...
    pub(crate) fn read_v14<R: ReadBytes>(&mut self, data: &mut R, extra_data: &Option<DecodeableExtraData>) -> Result<()> {
        ...
        self.pdlc_mask = data.read_i32()? as u64;
    ...
    pub(crate) fn write_v14<W: WriteBytes>(&mut self, buffer: &mut W, extra_data: &Option<EncodeableExtraData>) -> Result<()> {
        ...
        buffer.write_i32(self.pdlc_mask as i32)?;
