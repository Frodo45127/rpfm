...
impl Cs2Parsed {
    ...
    pub(crate) fn read_v11<R: ReadBytes>(&mut self, data: &mut R) -> Result<()> {
        ...
        for _ in 0..data.read_u32()? {
            ...
            for _ in 0..data.read_u32()? {
                ...
                for _ in 0..data.read_i32()? {
                    ...
                    collision_1.read_v11(data)?;
                    collision_2.read_v11(data)?;
    ...
    pub(crate) fn write_v11<W: WriteBytes>(&mut self, buffer: &mut W) -> Result<()> {
        ...
        for piece in &mut self.pieces {
            ...
            for destruct in &mut piece.destructs {
                ...
                for gate in &mut destruct.gates {
                    gate.collision_1.write_v11(buffer)?;
                    gate.collision_2.write_v11(buffer)?;
