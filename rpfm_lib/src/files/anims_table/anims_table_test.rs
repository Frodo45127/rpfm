...
//! Module containing tests for decoding/encoding `AnimsTable` files.
...
use super::AnimsTable;

#[test]
fn test_encode_anims_table() {
    let path_1 = "../test_files/test_decode_anims_table.bin";
