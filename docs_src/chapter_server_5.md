...
All MCP tool responses are JSON-serialized versions of the server's internal `Response` enum. The same [serialization convention](./chapter_server_0.md#serialization-convention) applies — refer to the [Responses](./chapter_server_3.md) page for the full list of response types and their payloads.
...
Refer to the [Shared Types](./chapter_server_1.md) page for the structure of these types.
